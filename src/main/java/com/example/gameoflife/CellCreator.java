        ...
        for(int x = 0; x < width; x++) {
            for(int y = 0; y < height; y++) {
                ...
                if (x>0 && y>0 && x<width-1 && y<height-1) {
                    AcquaintanceElement left = new AcquaintanceElement(cells[y][x-1], 4);
                    AcquaintanceElement topLeft = new AcquaintanceElement(cells[y-1][x-1], 5);
                    AcquaintanceElement top = new AcquaintanceElement(cells[y-1][x], 6);
                    AcquaintanceElement topRight = new AcquaintanceElement(cells[y-1][x+1], 7);
                    AcquaintanceElement right = new AcquaintanceElement(cells[y][x+1], 0);
                    AcquaintanceElement bottomRight = new AcquaintanceElement(cells[y+1][x+1], 1);
                    AcquaintanceElement bottom = new AcquaintanceElement(cells[y+1][x], 2);
                    AcquaintanceElement bottomLeft = new AcquaintanceElement(cells[y+1][x-1], 3);
